...
/* ============================================================
   CINEMATIC SOUND — starts only from a real user gesture
   ============================================================ */
...
let treeStartT = 0, treeLastT = 0, treeRAF = 0, lastPetal = 0, replayArmed = false, creditsShown = false;
...
function treeFrame(now){
  ...
  if (!creditsShown && t >= T.done - 0.2){
    creditsShown = true;
    creditsEl?.classList.add('is-in');
  }
...
function treeStart(){
  treeStartT = 0; treeLastT = 0; lastPetal = 0; replayArmed = false; creditsShown = false; window.bdayDone = false;
  creditsEl?.classList.remove('is-in');
  cue('grow');
  buildScene();
